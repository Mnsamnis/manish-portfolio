...
const Banner = () => {
  ...
  const tags = ["A Full Stack Developer"];
  ...
  return (
    <>
      <div
        id="banner"
        className="main-container  flex flex-col md:flex-row items-center py-4"
      >
        {/* First */}
        <div className="w-full md:w-1/2 flex justify-center ">
          ...
          <div className="mt-4 w-2/3 md:ms-10 text-gray-900">
            ...
            <p className="mt-4 mb-3">
              With a knack for problem-solving and a passion for technology, I
              craft innovative solutions using Java and SpringBoot. Explore my
              projects, skills, and connect with me on GitHub, LinkedIn, or drop
              a message to start a conversation.
            </p>
            ...
            <br />
            <div className="px-5 py-2 w-32 bg-[#cfb6a4] rounded-full shadow-lg  duration-200 ease-in hover:scale-105 cursor-pointer">
              <a href="https://www.linkedin.com/in/manish-kumar-373aa21b2">Contact Me</a>
            </div>
          </div>
        </div>
        {/* Second */}
